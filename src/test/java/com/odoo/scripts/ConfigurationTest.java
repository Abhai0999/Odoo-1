...
{ 
	...
	public void createUsers() 
	{
		...
		String[] userData = eu.readData("Sheet1","create_user_ID");
	...
	public void createActivityType() 
	{
		String filepath=GenericLib.dir+"/testdata/Odoodata.xlsx";
		ExcelUtilities eu=new ExcelUtilities(filepath);
		eu.readAndWriteData2("Sheet2","Sheet1","create_activityType_ID",6);
		String[] activityData = eu.readData("Sheet1","create_activityType_ID");
		lf.login(activityData[1],activityData[2]);
		cff.createActivityType(activityData);
	}
}