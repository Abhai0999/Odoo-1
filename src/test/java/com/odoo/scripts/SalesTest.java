...
public class SalesTest extends BaseAbstractTest
{
	...
	public void newCustomer() 
	{
		...
		String[] customerData = eu.readData("Sheet1", "create customer_ID");
		lf.login(customerData[1], customerData[2]);		
		sf.createNewCustomer(customerData);		
		String[] customerName = eu.readData("Sheet1", "create customer_ID");		  
	...
	public void dltNewCustomer()
	{
		...
		String[] customerData = eu.readData("Sheet1", "create customer_ID");
		lf.login(customerData[1], customerData[2]);
		String[] customerData1 =eu.readData("Sheet1", "delete_customerID");
